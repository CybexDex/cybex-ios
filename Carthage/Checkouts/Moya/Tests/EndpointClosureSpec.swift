...
final class SessionManagerMock: SessionManager {
    ...
    override func upload(multipartFormData: @escaping (Alamofire.MultipartFormData) -> Void, usingThreshold _: UInt64, with _: URLRequestConvertible, encodingCompletion _: ((SessionManager.MultipartFormDataEncodingResult) -> Void)?) {
