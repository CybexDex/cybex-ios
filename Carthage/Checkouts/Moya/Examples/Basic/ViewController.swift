...
class ViewController: UITableViewController {
    ...
    @IBAction func giphyWasPressed(_: UIBarButtonItem) {
        uploadGiphy()
    }

    @IBAction func searchWasPressed(_: UIBarButtonItem) {
    ...
    @IBAction func zenWasPressed(_: UIBarButtonItem) {
        downloadZen()
    }

    @IBAction func downloadWasPressed(_: UIBarButtonItem) {
        downloadMoyaLogo()
    }
