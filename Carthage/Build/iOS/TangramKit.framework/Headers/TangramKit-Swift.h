...
+ (void)tg_updateArabicUI:(BOOL)isArabic inWindow:(UIWindow * _Nonnull)window SWIFT_DEPRECATED_OBJC("Swift method 'TGBaseLayout.tg_updateArabicUI(_:inWindow:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
