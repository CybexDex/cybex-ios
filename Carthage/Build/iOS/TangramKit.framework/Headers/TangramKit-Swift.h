...
@property (nonatomic) BOOL tg_layoutHiddenSubviews SWIFT_DEPRECATED_OBJC("Swift property 'TGBaseLayout.tg_layoutHiddenSubviews' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// 返回当前布局视图是否正在执行布局。
