...
SWIFT_CLASS("_TtC10SwiftTheme21ThemeBlurEffectPicker")
...
@interface ThemeBlurEffectPicker (SWIFT_EXTENSION(SwiftTheme))
...
SWIFT_CLASS("_TtC10SwiftTheme34ThemeNavigationBarAppearancePicker") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@interface ThemeNavigationBarAppearancePicker (SWIFT_EXTENSION(SwiftTheme))
