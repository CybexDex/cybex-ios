...
public final class WithdrawInfoQuery: GraphQLQuery {
  public static let operationString =
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct WithdrawInfo: GraphQLSelectionSet {
      ...
      public init(minValue: Double, fee: Double, type: String, asset: String, gatewayAccount: String) {
        self.init(snapshot: ["__typename": "WithdrawInfo", "minValue": minValue, "fee": fee, "type": type, "asset": asset, "gatewayAccount": gatewayAccount])
      }
