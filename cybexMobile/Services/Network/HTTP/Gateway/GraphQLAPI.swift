...
public final class GetDepositAddressQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct GetDepositAddress: GraphQLSelectionSet {
      ...
      public init(accountName: String, address: String, type: String? = nil, asset: String, createAt: String? = nil, projectInfo: ProjectInfo? = nil) {
        self.init(unsafeResultMap: ["__typename": "AccountAddressRecord", "accountName": accountName, "address": address, "type": type, "asset": asset, "createAt": createAt, "projectInfo": projectInfo.flatMap { (value: ProjectInfo) -> ResultMap in value.resultMap }])
      }
