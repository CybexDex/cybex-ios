...
struct BroadcastTransactionRequest: JSONRPCKit.Request, JSONRPCResponse {
  ...
  var parameters: Any? {
    return [WebsocketService.shared.ids[apiCategory.network_broadcast] ?? 0, broadcastCatogery.broadcast_transaction_with_callback.rawValue, [0, JSON(jsonstr).dictionaryObject ?? [:]]]
  }
