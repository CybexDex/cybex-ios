...
protocol CBTheme {
  ...
  /// 十字线颜色
  var longPressLineColor: UIColor { get }
...
public class CBMainConfiguration {
  ...
  /// 时间线
  var timeLineType: CBTimeLineType = .fiveMinute
...
class BlackKLineTheme: CBTheme {
  ...
  var longPressLineColor: UIColor = #colorLiteral(red: 0.9999966025, green: 0.9999999404, blue: 0.9999999404, alpha: 0.1199999973)
