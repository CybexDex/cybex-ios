...
open class iProgressHUD {
    ...
    open var captionSize: CGFloat = 16
    ...
    fileprivate func boxSetting(view: UIView) {
        let boxCenter = CGPoint(x: view.bounds.size.width / 2, y: view.bounds.size.height / 2 - boxYOffset)
    ...
    fileprivate func captionSetting() {
        self.captionView.locali = R.string.localizable.progress_hud_loading.key
