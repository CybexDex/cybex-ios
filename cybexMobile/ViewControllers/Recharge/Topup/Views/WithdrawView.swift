    ...
    var data: Any? {
        didSet {
            if let data = data as? AccountAddressRecord {
                ...
                if data.asset.filterSystemPrefix == AssetConfiguration.CybexAsset.XRP.rawValue || data.asset.filterSystemPrefix == AssetConfiguration.CybexAsset.ATOM.rawValue || data.asset.filterSystemPrefix == AssetConfiguration.CybexAsset.IRIS.rawValue {
